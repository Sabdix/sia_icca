...
IF EXISTS (SELECT * FROM sysobjects WHERE name='SP_DT_RENUEVA_SALDOS_VACACIONALES')
BEGIN
	DROP PROCEDURE SP_DT_RENUEVA_SALDOS_VACACIONALES
END
GO
...
-- =============================================
CREATE PROCEDURE SP_DT_RENUEVA_SALDOS_VACACIONALES
...
GRANT EXECUTE ON SP_DT_RENUEVA_SALDOS_VACACIONALES TO public;  
GO
...
--Actualziación de saldos vacacionales
EXECUTE SP_DT_RENUEVA_SALDOS_VACACIONALES
GO